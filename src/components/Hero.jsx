  ...
  return (
    <section id="home" className="overflow-hidden">
      <div className="min-h-screen relative flex md:flex-row flex-col-reverse md:items-end justify-center items-center">
        ...
        {/* first col */}
        <div className="pb-16 px-6 pt-5 mb-4 bg-cardLinear rounded-lg shadow-black shadow-2xl border-slate-400 border-2" data-aos="fade-down">
          <h2>{hero.title}</h2>
          <br />
        ...
        {/* sec col */}
        <div className="md:h-[37rem] h-96 mt-16">
          <img
            src={hero.image}
            data-aos="slide-up"
            alt="..."
